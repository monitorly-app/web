...
export default function ServersIndex({ project, servers, stats, permissions, userPlan }: Props) {
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title={`${project.name} - Servers`} />
            ...
            <div className="p-6">
                <div className="mb-6 flex items-center justify-between">
                    ...
                    {canCreateServer ? (
                        <Button asChild>
                            <Link href={`/projects/${project.id}/servers/create`}>
                                                ...
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <div>
                                                        ...
                                                        {server.agent_version && (
                                                            <div className="text-muted-foreground text-xs">Agent v{server.agent_version}</div>
                                                        )}
                                                    </div>
                                                </div>
                                            </TableCell>
                                            ...
                                            <TableCell>
                                                <div className="flex items-center justify-center space-x-4">
                                                    <div className="text-center">
                                                        ...
                                                        <div className={`text-xs font-medium ${getMetricColor(server.metrics.cpu_usage)}`}>
                                                            {formatMetric(server.metrics.cpu_usage)}
                                                        </div>
                                                    </div>
                                                    <div className="text-center">
                                                        <div className="mb-1 flex items-center justify-center">
                                                        ...
                                                        <div className={`text-xs font-medium ${getMetricColor(server.metrics.memory_usage)}`}>
                                                            {formatMetric(server.metrics.memory_usage)}
                                                        </div>
                                                    </div>
                                                    <div className="text-center">
                                                        <div className="mb-1 flex items-center justify-center">
                                                        ...
                                                        <div className={`text-xs font-medium ${getMetricColor(server.metrics.disk_usage)}`}>
                                                            {formatMetric(server.metrics.disk_usage)}
                                                        </div>
                                                    </div>
                                                </div>
                                            </TableCell>
                                            <TableCell>
                                                <div className="text-sm">{formatLastSeen(server.last_seen)}</div>
                                            </TableCell>
                                            <TableCell>
                                                    ...
                                                    <DropdownMenu>
                                                        ...
                                                        <DropdownMenuContent align="end">
                                                            <DropdownMenuItem asChild>
                                                                <Link href={`/projects/${project.id}/servers/${server.id}`}>
                                                                    <Activity className="mr-2 h-4 w-4" />
                                                                    View Details
                                                                </Link>
                                                            </DropdownMenuItem>
                                                            <DropdownMenuItem asChild>
                                                                <Link href={`/projects/${project.id}/servers/${server.id}/edit`}>
