                        ...
                        <div className="flex flex-col gap-6 md:flex-row">
                            <div className="flex-1 space-y-4">
                                <div className="flex items-center">
                                    <span className="text-2xl font-bold">{user.plan?.name || 'No Plan'}</span>
                                    {user.plan?.price > 0 && (
                                        <span className="text-muted-foreground ml-2 text-sm">{user.plan.price} € per month</span>
                                    )}
                                </div>
                                ...
                                <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xl">{user.plan?.max_servers || 'N/A'}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xl">{user.plan?.max_users || 'N/A'}</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-2">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xl">{user.plan?.frequency || 'N/A'} min</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
