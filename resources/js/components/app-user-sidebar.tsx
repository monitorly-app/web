...
import { BookOpen, Folder, LayoutGrid, Package, Server, Settings, Users } from 'lucide-react';
import AppLogo from './app-logo';
import { OrganizationSelectorDropdown } from './organization-selector-dropdown';

export function AppUserSidebar() {
    const { auth, currentOrganization, organizations, organizationLimits } = usePage<SharedData>().props;
    ...
    const mainNavItems: NavItem[] = !currentOrganization
        ? [
              {
                  title: 'Dashboard',
    ...
    if (currentOrganization) {
        ...
        // Settings - pour owners et admins
                ...
                <SidebarMenu>
                    <SidebarMenuItem>
                        <SidebarMenuButton size="lg" asChild>
                            <Link href={currentOrganization ? `/organizations/${currentOrganization.id}` : '/organizations/select'} prefetch>
                                <AppLogo />
                            </Link>
                        </SidebarMenuButton>
                    </SidebarMenuItem>
